...
namespace RDI.NFe2.Business
{
    public static class ConverteNFe
    {
        ...
        private static TNFeInfNFeDetImpostoIPIIPITrib IPITrib;
        private static TNFeInfNFeDetImpostoPISPISOutr PISOutr;
        private static TNFeInfNFeDetImpostoCOFINSCOFINSOutr COFINSOutr;
        private static String UF; 
        //provisorio
        private static Boolean ForceTpAmb;

        //public static void Txt2Xml(string arqTXT, Boolean __ForceTpAmb, Parametro oParam)
        //{
        //    ForceTpAmb = __ForceTpAmb;
        ...
        //            String chave;
        //            chave = UF +
        //                    String.Format("{0:yy}", oNotaFiscalXML.infNFe.ide.dEmi) +
        //                    String.Format("{0:MM}", oNotaFiscalXML.infNFe.ide.dEmi) +
        ...
        //            NFe2.Business.Servicos.SalvaXML(oParam.pastaEntrada + chave + ".xml", oNotaFiscalXML);
        //            File.Delete(arqTXT);
        //        }
        //        else
        //        {
        ...
        private static TUf DefineUF(String UF)
        {
            try
            {
                return (TUf)Enum.Parse(typeof(TUf), UF);
            }
            catch
            {
        ...
        private static Enum DefineEnum(String value, Type EnumType)
        {
        ...
        //        oNotaFiscalXML.infNFe.ide.dEmi = itens[8];//AAAA-MM-DD
        //        if (!String.IsNullOrEmpty(itens[9]))
        //        {
        //            oNotaFiscalXML.infNFe.ide.dSaiEnt = itens[9];
        //        }
        ...
        //        if (ForceTpAmb)
        //        {
        //            oNotaFiscalXML.infNFe.ide.tpAmb = oParam.tipoAmbiente;
        //        }
        //        else
        //        {
        ...
        //        oNotaFiscalXML.infNFe.emit.ItemElementName = ItemChoiceType6.CNPJ;
        //    }
        //    else if (itens[0] == "C02a")
        //    {
        //        oNotaFiscalXML.infNFe.emit.Item = itens[1];
        //        oNotaFiscalXML.infNFe.emit.ItemElementName = ItemChoiceType6.CPF;
        //    }
        //    else if (itens[0] == "C05")
        //    {
        ...
        //        oNotaFiscalXML.infNFe.emit.enderEmit.UF = DefineUF(itens[7]);
        //        if (!String.IsNullOrEmpty(itens[8]))
        //            oNotaFiscalXML.infNFe.emit.enderEmit.CEP = itens[8];
        //        if (!String.IsNullOrEmpty(itens[9]))
        //            oNotaFiscalXML.infNFe.emit.enderEmit.cPais = itens[9];
        //        if (!String.IsNullOrEmpty(itens[10]))
        //            oNotaFiscalXML.infNFe.emit.enderEmit.xPais = itens[10];
        //        if (!String.IsNullOrEmpty(itens[11]))
        //            oNotaFiscalXML.infNFe.emit.enderEmit.fone = itens[11];
        //    }
        //    else if (itens[0] == "D") //GRUPO EXCLUSIVO DO FISCO , NÃO UTILIZAR.
        //    {
        //        //ocorrencia : 0-1
        //        oNotaFiscalXML.infNFe.avulsa = new TNFeInfNFeAvulsa();
        //        oNotaFiscalXML.infNFe.avulsa.CNPJ = itens[1];
        //        oNotaFiscalXML.infNFe.avulsa.xOrgao = itens[2];
        //        oNotaFiscalXML.infNFe.avulsa.matr = itens[3];
        //        oNotaFiscalXML.infNFe.avulsa.xAgente = itens[4];
        //        oNotaFiscalXML.infNFe.avulsa.fone = itens[5];
        //        oNotaFiscalXML.infNFe.avulsa.UF = DefineUF(itens[6]);
        //        oNotaFiscalXML.infNFe.avulsa.nDAR = itens[7];
        //        oNotaFiscalXML.infNFe.avulsa.dEmi = Convert.ToDateTime(itens[8]);
        //        oNotaFiscalXML.infNFe.avulsa.vDAR = itens[9];
        //        oNotaFiscalXML.infNFe.avulsa.repEmi = itens[10];
        //        if (!String.IsNullOrEmpty(itens[11]))
        //        {
        //            oNotaFiscalXML.infNFe.avulsa.dPag = Convert.ToDateTime(itens[11]);
        //            oNotaFiscalXML.infNFe.avulsa.dPagSpecified = true;
        //        }
        ...
        //        oNotaFiscalXML.infNFe.dest.ItemElementName = ItemChoiceType1.CNPJ;
        //    }
        //    else if (itens[0] == "E03")
        //    {
        //        oNotaFiscalXML.infNFe.dest.Item = itens[1];
        //        oNotaFiscalXML.infNFe.dest.ItemElementName = ItemChoiceType1.CPF;
        //    }
        //    else if (itens[0] == "E05")
        //    {
        ...
        //        if (!String.IsNullOrEmpty(itens[9]))
        //            oNotaFiscalXML.infNFe.dest.enderDest.cPais = itens[9];
        //        if (!String.IsNullOrEmpty(itens[10]))
        ...
        //        oNotaFiscalXML.infNFe.retirada.CNPJ = itens[1];
        ...
        //        oNotaFiscalXML.infNFe.entrega.CNPJ = itens[1];
        ...
        //        oNotaFiscalXML.infNFe.det[numeroItem].prod.DI[numeroItemDI].dDI = Convert.ToDateTime(itens[2]);
        //        oNotaFiscalXML.infNFe.det[numeroItem].prod.DI[numeroItemDI].xLocDesemb = itens[3];
        //        oNotaFiscalXML.infNFe.det[numeroItem].prod.DI[numeroItemDI].UFDesemb = DefineUF(itens[4]);
        //        oNotaFiscalXML.infNFe.det[numeroItem].prod.DI[numeroItemDI].dDesemb = Convert.ToDateTime(itens[5]);
        ...
        //        med.nLote = itens[1];
        //        med.qLote = itens[2];
        //        med.dFab = Convert.ToDateTime(itens[3]);
        //        med.dVal = Convert.ToDateTime(itens[4]);
        //        med.vPMC = itens[5];
