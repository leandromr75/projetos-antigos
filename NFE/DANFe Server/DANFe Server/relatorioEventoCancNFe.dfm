object EventoCancNFeREL: TEventoCancNFeREL
  Left = 135
  Top = 152
  Width = 1036
  Height = 780
  VertScrollBar.Position = 301
  Caption = 'EventoCancNFeREL'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object QREventoCancNFe: TQuickRep
    Left = 0
    Top = -301
    Width = 1111
    Height = 1572
    ...
    BeforePrint = QREventoCancNFeBeforePrint
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object detailBand: TQRBand
      ...
      object QRLabel5: TQRLabel
        ...
        BiDiMode = bdLeftToRight
        ParentBiDiMode = False
        Caption = 'Cancelamento de NF-e por evento'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'PROTOCOLO DE AUTORIZA'#199#195'O NF-E'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -7
  ...
  object XTRProcCancNFe: TXMLTransformProvider
    TransformRead.TransformationFile = '.\xsd\ToDpProcCCe_CancNFe.xtr'
    TransformWrite.TransformationFile = '.\xsd\ToDpProcCCe_CancNFe.xtr'
    Top = 6
  end
  object dsProcCancNFe: TDataSource
    DataSet = cdsProcCancNFe
    Top = 70
  end
  object cdsProcCancNFe: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'XTRProcCancNFe'
    Top = 38
    object cdsProcCancNFeversao1: TStringField
      FieldName = 'versao1'
      Required = True
      Size = 1000
    end
    object cdsProcCancNFeevento_versao: TStringField
      FieldName = 'evento_versao'
      Required = True
      Size = 1000
    end
    object cdsProcCancNFeinfEvento_Id: TStringField
      FieldName = 'infEvento_Id'
      Required = True
      Size = 1000
    end
    object cdsProcCancNFeinfEvento_cOrgao: TStringField
      FieldName = 'infEvento_cOrgao'
      Size = 1000
    end
    object cdsProcCancNFeinfEvento_tpAmb: TStringField
      FieldName = 'infEvento_tpAmb'
      Size = 1000
    end
    object cdsProcCancNFeCNPJ: TStringField
      FieldName = 'CNPJ'
      Size = 1000
    end
    object cdsProcCancNFeCPF: TStringField
      FieldName = 'CPF'
      Size = 1000
    end
    object cdsProcCancNFeinfEvento_chNFe: TStringField
      FieldName = 'infEvento_chNFe'
      Size = 1000
    end
    object cdsProcCancNFedhEvento: TStringField
      FieldName = 'dhEvento'
      Size = 1000
    end
    object cdsProcCancNFeinfEvento_tpEvento: TStringField
      FieldName = 'infEvento_tpEvento'
      Size = 1000
    end
    object cdsProcCancNFeinfEvento_nSeqEvento: TStringField
      FieldName = 'infEvento_nSeqEvento'
      Size = 1000
    end
    object cdsProcCancNFeverEvento: TStringField
      FieldName = 'verEvento'
      Size = 1000
    end
    object cdsProcCancNFeversao2: TStringField
      FieldName = 'versao2'
      Required = True
      Size = 1000
    end
    object cdsProcCancNFedescEvento: TStringField
      FieldName = 'descEvento'
      Size = 1000
    end
    object cdsProcCancNFenProtAutorizacao: TStringField
      FieldName = 'nProtAutorizacao'
      Size = 1000
    end
    object cdsProcCancNFexJust: TStringField
      FieldName = 'xJust'
      Size = 1000
    end
    object cdsProcCancNFeretEvento_versao: TStringField
      FieldName = 'retEvento_versao'
      Required = True
      Size = 1000
    end
    object cdsProcCancNFeinfRetEvento_Id: TStringField
      FieldName = 'infRetEvento_Id'
      Required = True
      Size = 1000
    end
    object cdsProcCancNFeinfRetEvento_tpAmb: TStringField
      FieldName = 'infRetEvento_tpAmb'
      Size = 1000
    end
    object cdsProcCancNFeverAplic: TStringField
      FieldName = 'verAplic'
    end
    object cdsProcCancNFeinfRetEvento_cOrgao: TStringField
      FieldName = 'infRetEvento_cOrgao'
      Size = 1000
    end
    object cdsProcCancNFecStat: TStringField
      FieldName = 'cStat'
      Size = 1000
    end
    object cdsProcCancNFexMotivo: TStringField
      FieldName = 'xMotivo'
      Size = 255
    end
    object cdsProcCancNFeinfRetEvento_chNFe: TStringField
      FieldName = 'infRetEvento_chNFe'
      Size = 1000
    end
    object cdsProcCancNFeinfRetEvento_tpEvento: TStringField
      FieldName = 'infRetEvento_tpEvento'
      Size = 1000
    end
    object cdsProcCancNFexEvento: TStringField
      FieldName = 'xEvento'
      Size = 60
    end
    object cdsProcCancNFeinfRetEvento_nSeqEvento: TStringField
      FieldName = 'infRetEvento_nSeqEvento'
      Size = 1000
    end
    object cdsProcCancNFeCNPJDest: TStringField
      FieldName = 'CNPJDest'
      Size = 1000
    end
    object cdsProcCancNFeCPFDest: TStringField
      FieldName = 'CPFDest'
      Size = 1000
    end
    object cdsProcCancNFeemailDest: TStringField
      FieldName = 'emailDest'
      Size = 60
    end
    object cdsProcCancNFedhRegEvento: TStringField
      FieldName = 'dhRegEvento'
      Size = 1000
    end
    object cdsProcCancNFenProt: TStringField
      FieldName = 'nProt'
      Size = 1000
    end
  end
